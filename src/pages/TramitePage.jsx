...
export const TramitePage = () => {
  return (
    <>
      ...
      <p className="procedure-title">Certificado Nivel Licenciatura</p>
      ...
      <div className="steps">
        ...
        <div className="step-2">
          ...
          <p>Fecha asignada: 13/03/2018</p>

          <p style={{ width: '80%', fontSize: '18px' }}>
            Llevar la siguiente papelería en original y un juego de copias:
          </p>
          ...
          <ul style={{ fontSize: '18px' }}>
            ...
            <li>
              <a href="https://www.gob.mx/curp/">CURP</a>
            </li>
            <li>KARDEX</li>
            <li>
          ...
          <div style={{ display: 'flex' }}>
            <a href="/documents/carta_de_consentimiento.pdf" download="cartaConsentimiento.pdf">
              <button className="btn-payment" style={{ width: '190px', marginRight: '10px' }}>
                <PrinterLogo />
                <span className="btn-title">Carta Consentimiento</span>
              </button>
            </a>
            ...
            <a href="/documents/solicitud_titulo_UANL.pdf" download="hojaSolicitud.pdf">
              <button className="btn-payment">
                <PrinterLogo />
                <span className="btn-title">Hoja de Solicitud</span>
              </button>
            </a>
          </div>
        </div>
